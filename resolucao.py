...
def teste_manne_minlafav(prefixo_arq = "t_minlafav_",  ini_amostra=0, tam_amostra=20, tempo_max=120, fl_primeira_sol = False, fl_heuristica_desabilitada=False):
    instancias = criar_instancias()
    solucao = []
    ...
    for i in range(ini_amostra, tam_amostra): 
        for fl_inteiro in [True, False]:
